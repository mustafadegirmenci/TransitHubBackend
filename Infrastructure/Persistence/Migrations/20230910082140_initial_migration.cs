        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Responses_ResponseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teams_Responses_ResponseId",
                        column: x => x.ResponseId,
                        principalTable: "Responses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Teams_Responses_ResponseId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ResponseId",
                table: "Reservations",
                column: "ResponseId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_ResponseId",
                table: "Teams",
                column: "ResponseId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Teams_ResponseId1",
                table: "Teams",
                column: "ResponseId1");
